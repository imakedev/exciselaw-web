...
/**
 * The persistent class for the V_CONSULT_DOC database table.
 * 
 */
@Entity
@Table(name="V_CONSULT_DOC")
public class VConsultDoc implements Serializable {
