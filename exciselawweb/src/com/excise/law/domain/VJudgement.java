...
/**
 * The persistent class for the V_JUDGEMENT database table.
 * 
 */
@Entity
@Table(name="V_JUDGEMENT")
public class VJudgement implements Serializable {
	...
	public void setJudgementId(BigDecimal judgementId) {
