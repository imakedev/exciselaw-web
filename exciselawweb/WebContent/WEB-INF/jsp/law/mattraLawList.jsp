...
function doEdit(id){ 
	window.location=_path+'/law/mattraLaw.do?action=edit&mattraLawId='+id;
} function callfunc(functype){	
	
	var mattraLaw={ 
		mattraLawType:document.getElementById("mattraLawType").value,
		statueId:document.getElementById("statueId").value,
		articleGroupId:document.getElementById("articleGroupId").value,
		mattraLawName:document.getElementById("mattraLawName").value
	};
	var paging={
	...
	ExciseLawAjax.searchArticleSectionList(mattraLaw , paging,{
		 callback:function(dataFromServer){
            if(dataFromServer!=null && dataFromServer.length>0){ 
				 var mattraLawList=dataFromServer[0]; 
				 for(var i=0;i<mattraLawList.length;i++){
					 oTable.fnAddData([mattraLawList[i].mattraLawType?mattraLawList[i].mattraLawType=='E'?"กฎหมายสรรพสามิต":"กฎหมายอื่น":"",
							 			mattraLawList[i].statueId?mattraLawList[i].statueId:"",
									 	mattraLawList[i].articleGroupId?mattraLawList[i].articleGroupId:"",
									 	mattraLawList[i].mattraLawName?mattraLawList[i].mattraLawName:"",
										mattraLawList[i].mattraLawOrder?mattraLawList[i].mattraLawOrder:"",
					                   	"<span style=\"cursor: pointer, align: center;\" title=\"ดูรายละเอียดข้อมูล\"  onclick=\"return doEdit("+mattraLawList[i].mattraLawId+")\"><img  border=\"0\" src=\""+_path+"/images/icon_15.gif\"/></span>"
					                   ]);
				 }
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td align="right">
				...
				<INPUT TYPE="button" value="เพิ่มข้อมูล" style="width: 80px" onClick="javascript:window.location='<spring:url value="/law/mattraLaw.do?action=add" htmlEscape="true" />'" >
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">			
		...
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">    
				<tr>
					...
					<td width="25%" height="25" colspan="3">&nbsp;
				...
				<tr>
					...
					<td width="25%" height="25" class="Ghead">&nbsp;
						<select name="tmArticleSection.statueId" id="statueId" cssStyle="width: 250px" cssClass="dropdown">
						    <option value="">- - - Please Select - - -</option>
				...
				<tr>
					...
					<td width="40%" height="25">&nbsp;
						<input type="text" name="tmArticleSection.governmentGazetteName" id="governmentGazetteName" cssClass="text" cssStyle="width: 250px" maxlength="200"/>
					</td>
				</tr>
			</table>
        </td>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
			...
			<tbody  class="text">
				<tr>
					<td>พระราชบัญญัติ1</td>
					<td>ประเภทกฎหมาย1</td>
					<td>ชื่อพ.ร.บ./พ.ร.ก./พ.ร.ฎ.1</td>
					<td>หมวด1</td>
					<td>เล่ม1</td>
					<td>ส่วนที่1</td>
					<td>เลขมาตรา1</td>
					<td>1</td>
					<td><span style="cursor: pointer, align: center;" title="ดูรายละเอียดข้อมูล"  onclick="return doEdit(1)"><img  border="0" src="<%=request.getContextPath() %>/images/icon_15.gif"/></span></td>
				</tr>
			</tbody>	 
		</table>
		</td>
