...
function doEdit(id){ 
	window.location=_path+'/law/exArticleHeader.do?action=edit&articleHeaderId='+id;
	...
	var exArticleHeader={ 
		...
		articleHeaderName:document.getElementById("articleHeaderName").value,
	...
	ExciseLawAjax.searchExArticleHeaderList(exArticleHeader , paging,{
		 callback:function(dataFromServer){
            if(dataFromServer!=null && dataFromServer.length>0){ 
				 var exArticleHeaderList=dataFromServer[0]; 
				 for(var i=0;i<exArticleHeaderList.length;i++){
					 oTable.fnAddData([exArticleHeaderList[i].articleHeaderId?exArticleHeaderList[i].articleHeaderId:"",
						 				exArticleHeaderList[i].statueName?exArticleHeaderList[i].statueName:"",
							 			exArticleHeaderList[i].lawTypeName?exArticleHeaderList[i].lawTypeName:"",
									 	exArticleHeaderList[i].articleHeaderName?exArticleHeaderList[i].articleHeaderName:"",
									 	exArticleHeaderList[i].gazetteNo?exArticleHeaderList[i].gazetteNo:"",
										exArticleHeaderList[i].gazetteVol?exArticleHeaderList[i].gazetteVol:"",
										exArticleHeaderList[i].gazetteEpisode?exArticleHeaderList[i].gazetteEpisode:"",
										exArticleHeaderList[i].gazetteDated?exArticleHeaderList[i].gazetteDated:"",
					                   	"<span style=\"cursor: pointer, align: center;\" title=\"ดูรายละเอียดข้อมูล\"  onclick=\"return doEdit("+exArticleHeaderList[i].articleHeaderId+")\"><img  border=\"0\" src=\""+_path+"/images/icon_15.gif\"/></span>"
					                   ]);
				 }
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td height="30" class="head2"><strong>กฎหมายสรรพสามิต >> พ.ร.บ./พ.ร.ก./พ.ร.ฎ. >></strong><font color="#000000">ค้นหาข้อมูล </font></td>
		<td align="right">
			
				<INPUT TYPE="button" value="เพิ่มข้อมูล" style="width: 80px" onClick="javascript:window.location='<spring:url value="/law/exArticleHeader.do?action=add" htmlEscape="true" />'" >
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">			
	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">    
				...
				<tr>
					<td width="38%" align="right" height="25" class="Ghead">ชื่อกฎหมาย&nbsp;</td>
				...
				<tr>
					...
					<td width="62%" class="text">&nbsp;
						<form:input path="primaryKey" id="articleHeaderId" cssClass="text" cssStyle="width: 100px"/>
					</td>
				</tr>
			</table>
        </td>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
			<thead>
				<tr>
					<th width="5%" name="th_type" class="Ghead" align="left">ลำดับที่</th>
					<th width="12%" name="th_type" class="Ghead" align="left">พระราชบัญญัติ</th>
					<th width="12%" name="th_type" class="Ghead" align="left">ประเภทกฎหมาย</th>
					<th width="*" name="th_type" class="Ghead" align="left">ชื่อ</th>
					<th width="8%" name="th_type" class="Ghead" align="left">ฉบับ</th>
					<th width="8%" name="th_type" class="Ghead" align="left">เล่ม</th>
					<th width="8%" name="th_type" class="Ghead" align="left">ตอนที่</th>
					<th width="12%" name="th_type" class="Ghead" align="left">ลงวันที่</th>
