...
function doEdit(id){ 
	window.location=_path+'/law/law.do?action=edit&lawId='+id;
	...
	var law={ 
		...
		lawTitleThai:document.getElementById("lawTitleThai").value,
		lawEnforceStatus:document.getElementById("lawEnforceStatus").value,
		lawId:document.getElementById("lawId").value
	};
	var paging={
	...
	ExciseLawAjax.searchLawList(law, 1, paging,{
		 callback:function(dataFromServer){
            if(dataFromServer!=null && dataFromServer.length>0){ 
				 var lawList=dataFromServer[0]; 
				 for(var i=0;i<lawList.length;i++){
					 oTable.fnAddData([lawList[i].lawId?lawList[i].lawId:"",
										lawList[i].statueId?lawList[i].statueId:"",
							 			lawList[i].lawTypeId?lawList[i].lawTypeId:"",
									 	lawList[i].lawTitleThai?lawList[i].lawTitleThai:"",
									 	lawList[i].lawEnforceStatus?lawList[i].lawEnforceStatus=='1'?"มีผลบังคับใช้":"ไม่มีผลบังคับใช้":"",
					                   	"<span style=\"cursor: pointer, align: center;\" title=\"ดูรายละเอียดข้อมูล\"  onclick=\"return doEdit("+lawList[i].lawId+")\"><img  border=\"0\" src=\""+_path+"/images/icon_15.gif\"/></span>"
					                   ]);
				 }
...
<spring:url value="/law/law.do" var="formAction"></spring:url>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td height="30" class="head2"><strong>กฎหมายสรรพสามิต >> ข้อมูลกฏหมาย >> </strong><font color="#000000">ค้นหาข้อมูล </font></td>
		<td align="right">
			
				<INPUT TYPE="button" value="เพิ่มข้อมูล" style="width: 80px" onClick="javascript:window.location='<spring:url value="/law/law.do?action=add" htmlEscape="true" />'" >
		...
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">    
				<tr>
					...
					<td width="38%" height="25" class="text">&nbsp;
						<form:select path="tsLaw.statueId" id="statueId" cssStyle="width: 300px" cssClass="dropdown">
				...
				<tr>
					<td width="38%" align="right" class="Ghead">ประเภทกฎหมาย&nbsp;</td>                        
					<td width="38%"class="text">&nbsp;
						<form:select path="tsLaw.lawTypeId" id="lawTypeId" cssStyle="width: 300px" cssClass="dropdown">
						    <form:option value="" label="- - - Please Select - - -"/> 
				...
				<tr>
					<td width="38%" align="right" class="Ghead">ชื่อเรื่อง&nbsp;</td>
					<td width="62%" class="text">&nbsp;
						<form:input path="tsLaw.lawTitleThai" id="lawTitleThai" cssClass="text" cssStyle="width: 250px" maxlength="1000"/>
					</td>
				</tr>
				<tr>
					<td width="38%" align="right" class="Ghead">สถานะการบังคับใช้&nbsp;</td>                        
					<td width="62%" class="text">&nbsp;
						<form:select path="tsLaw.lawEnforceStatus" id="lawEnforceStatus" cssStyle="width: 300px" cssClass="dropdown">
						    <form:option value="" label="- - - Please Select - - -"/> 
				...
				<tr>
					<td width="38%" align="right" class="Ghead">ลำดับที่&nbsp;</td>                         
					<td width="62%" class="text">&nbsp; 
						<form:input path="primaryKey" id="lawId" cssClass="text" cssStyle="width: 50px" maxlength="100"/>
					</td>
				</tr> 
			</table>
        </td>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
			<thead>
				<tr>
					...
					<th width="*" name="th_type" class="Ghead" align="left">ชื่อเรื่อง</th>
					<th width="10%" name="th_type" class="Ghead" align="left">สถานะการบังคับใช้</th>
