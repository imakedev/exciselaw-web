...
function doEdit(id){ 
	window.location=_path+'/law/otherLaw.do?action=edit&lawId='+id;
	...
	ExciseLawAjax.searchLawList(otherLaw, 0, paging,{
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td height="30" class="head2"><strong>กฎหมายอื่นๆ >> ข้อมูลกฏหมายอื่นๆ >> </strong><font color="#000000">ค้นหาข้อมูล </font></td>
		<td align="right">
			
				<INPUT TYPE="button" value="เพิ่มข้อมูล" style="width: 80px" onClick="javascript:window.location='<spring:url value="/law/otherLaw.do?action=add" htmlEscape="true" />'" >
