...
function doEdit(id){ 
	window.location=_path+'/law/exArticleCompleted.do?action=edit&articleCompletedId='+id;
} function callfunc(functype){	
	
	var exArticleCompleted={ 
		...
		articleCompletedNumber:document.getElementById("articleCompletedNumber").value,
		articleCompletedId:document.getElementById("articleCompletedId").value
	};
	var paging={
	...
	ExciseLawAjax.searchArticleCompletedList(exArticleCompleted , paging,{
		 callback:function(dataFromServer){
            if(dataFromServer!=null && dataFromServer.length>0){ 
				 var exArticleCompletedList=dataFromServer[0]; 
				 for(var i=0;i<exArticleCompletedList.length;i++){
					 oTable.fnAddData([exArticleCompletedList[i].articleCompletedId?exArticleCompletedList[i].articleCompletedId:"",
							 			exArticleCompletedList[i].statueName?exArticleCompletedList[i].statueName:"",
									 	exArticleCompletedList[i].articleGroupName?exArticleCompletedList[i].articleGroupName:"",
										exArticleCompletedList[i].articleSectionName?exArticleCompletedList[i].articleSectionName:"",
									 	exArticleCompletedList[i].articleCompletedNumber?exArticleCompletedList[i].articleCompletedNumber:"",
										exArticleCompletedList[i].articleCompletedOrder?exArticleCompletedList[i].articleCompletedOrder:"",
					                   	"<span style=\"cursor: pointer, align: center;\" title=\"ดูรายละเอียดข้อมูล\"  onclick=\"return doEdit("+exArticleCompletedList[i].articleCompletedId+")\"><img  border=\"0\" src=\""+_path+"/images/icon_15.gif\"/></span>"
					                   ]);
				 }
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td height="30" class="head2"><strong>กฎหมายสรรพสามิต >> พระราชบัญญัติฉบับสมบูรณ์ >></strong><font color="#000000">ค้นหาข้อมูล </font></td>
		<td align="right">
			
				<INPUT TYPE="button" value="เพิ่มข้อมูล" style="width: 80px" onClick="javascript:window.location='<spring:url value="/law/exArticleCompleted.do?action=add" htmlEscape="true" />'" >
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">    
				<tr>
					...
					<td width="62%" height="25" colspan="3">&nbsp;
						<form:select path="tsExArticleCompleted.statueId" id="statueId" cssStyle="width: 300px" cssClass="dropdown">
				...
				<tr>
					<td width="38%" align="right" height="25" class="Ghead">หมวด&nbsp;</td>                        
					<td width="62%" height="25" class="Ghead">&nbsp;
				...
				<tr>
					<td width="38%" align="right" height="25" class="Ghead">ส่วนที่&nbsp;</td>                        
				...
				<tr>
					<td width="38%" align="right" height="25" class="Ghead">เลขมาตรา&nbsp;</td>
					<td width="62%" class="text"  colspan="3">&nbsp;
						<form:input path="tsExArticleCompleted.articleCompletedNumber" id="articleCompletedNumber" cssClass="text" cssStyle="width: 250px" maxlength="200"/>
					</td>
				</tr>
				<tr>
					<td width="38%" align="right" height="25" class="Ghead">ลำดับที่&nbsp;</td>
					<td width="62%" class="text">&nbsp;
						<form:input path="primaryKey" id="articleCompletedId" cssClass="text" cssStyle="width: 150px" maxlength="10"/>
					</td>
				</tr>
			</table>
        </td>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
			<thead>
				<tr>
					...
					<th width="*" name="th_type" class="Ghead" align="left">พระราชบัญญัติ</th>
