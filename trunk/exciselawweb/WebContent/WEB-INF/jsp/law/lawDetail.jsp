...
function checkStatueAll(){
	checkStatueAllByElementName(document.getElementsByName('statutesBoxes'));
}
function checkStatueAllByElementName(el_collection){
	var selectallValue= document.getElementById("selectAllStatute");
...
var myTabs = new YAHOO.widget.TabView("law");
...
<form:hidden path="tsLaw.lawExciseStatus" id="lawExciseStatus"/>
<table width="100%" border="0" cellpadding="0" cellspacing="0">	
	<tr>
		<td height="30" class="head2"><strong>กฎหมายสรรพสามิต >> ข้อมูลกฏหมาย >> </strong><font color="#000000">รายละเอียดข้อมูล</font></td>
		<td align="right">
			
				<INPUT TYPE="button" value="ย้อนกลับ" style="width: 80px" onClick="javascript:window.location='<spring:url value="/law/law.do?action=search" htmlEscape="true" />'" >
