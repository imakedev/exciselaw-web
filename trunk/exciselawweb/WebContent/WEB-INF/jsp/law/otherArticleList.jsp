...
function doEdit(id){ 
	window.location=_path+'/law/otherArticle.do?action=edit&articleId='+id;
	...
	ExciseLawAjax.searchArticleList(otherArticle, 0, paging,{
...
<spring:url value="/law/otherArticle.do" var="formAction"></spring:url>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td height="30" class="head2"><strong>กฎหมายอื่นๆ >> มาตรากฏหมายอื่นๆ >> </strong><font color="#000000">ค้นหาข้อมูล </font></td>
		<td align="right">
			
				<INPUT TYPE="button" value="เพิ่มข้อมูล" style="width: 80px" onClick="javascript:window.location='<spring:url value="/law/otherArticle.do?action=add" htmlEscape="true" />'" >
